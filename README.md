...
Check the [releases](https://github.com/droboports/nodejs/releases) page. If there are no releases available, then you have to compile.
...
```
git clone https://github.com/droboports/nodejs.git
cd nodejs
./build.sh
ls -la *.tgz
```
